import type { MarkupToken, PropertyToken, ScriptToken } from '@ossph/temple-parser';
...
export class IfDirective extends AbstractDirective {
  ...
  public markup(
    ...
    if (!token.attributes 
      ...
      throw CompilerException.for('Invalid if statement');
    }
...
export class ElifDirective extends AbstractDirective {
  ...
  public markup(
    ...
    if (!parent 
      ...
      throw CompilerException.for('Invalid elif statement');
    }
    const truesy = token.attributes.properties.find(
      property => property.key.name === 'true'
    );
...
export class ElseDirective extends AbstractDirective {
  ...
  public markup(
    ...
    if (!parent 
      ...
      throw CompilerException.for('Invalid else statement');
    }
