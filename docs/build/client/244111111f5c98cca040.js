var TempleBundle = (() => {
  ...
  var require_TempleRegistry = __commonJS({
    "../temple/dist/client/TempleRegistry.js"(exports) {
      ...
      var TempleRegistry8 = class {
        ...
        static createComponent(definition, attributes, children5 = []) {
          ...
          children5.forEach((child) => component.appendChild(child));
          component.init(attributes);
          component.TempleElement = component.element;
        ...
        static createElement(name, attributes, children5 = []) {
          ...
          children5.filter((child) => typeof child !== "undefined").forEach((child) => element.appendChild(child));
  ...
  var require_data = __commonJS({
    "../temple/dist/client/data.js"(exports) {
      ...
      var TempleDataMap = class extends Map {
        constructor() {
  ...
  var require_TempleComponent = __commonJS({
    "../temple/dist/client/TempleComponent.js"(exports) {
      ...
      var TempleComponent7 = class _TempleComponent extends HTMLElement {
        ...
        get element() {
          if (!this._element) {
            this._element = TempleRegistry_1.default.get(this);
            if (!this._element) {
              this._element = this.TempleElement || null;
            }
          }
          return this._element;
        }
        ...
        get props() {
          var _a;
          return Object.assign({}, ((_a = this.element) === null || _a === void 0 ? void 0 : _a.attributes) || {});
        }
        set props(props5) {
          if (this.element) {
            this.element.setAttributes(Object.assign({}, props5));
            this.render();
          }
        }
        adoptedCallback() {
        ...
        init(attributes = {}) {
          this._element = TempleRegistry_1.default.register(this, attributes);
        }
        render() {
          ...
          if (styles.length === 0) {
            this.textContent = "";
            children5.forEach((child) => this.appendChild(child));
          } else {
            if (!this.shadowRoot) {
  ...
  var require_props = __commonJS({
    "../temple/dist/client/props.js"(exports) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.default = props5;
      var data_1 = __importDefault(require_data());
      function props5(component = null) {
        if (!component) {
  ...
  var require_children = __commonJS({
    "../temple/dist/client/children.js"(exports) {
      ...
      function innerHTML(component = null) {
        const inner = children5(component);
        const wrapper = document.createElement("template");
        wrapper.append(...inner);
        return wrapper.innerHTML;
      }
      function children5(component = null) {
        if (!component) {
          component = data_1.default.get("current") || null;
        }
  ...
  // temple-document-client-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/sandbox.dtml
  var sandbox_exports = {};
  ...
  var PanelMain_b21c6a1d888781a72a3e = class extends import_client.TempleComponent {
    ...
    template() {
      ...
      const children5 = () => this.originalChildren;
      return () => [
  ...
  @media (max-width: 767px) {
    ...
    template() {
      ...
      return () => [
        import_client2.TempleRegistry.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/default.min.css` }).element,
...
`, false)
  ...
  .terminal span {
    ...
    template() {
      const { lang = "markup", inline = false, test } = (0, import_temple2.props)();
      const childlist = (0, import_temple2.children)();
      const snippet = childlist[0];
...
`, false)
  ...
  // temple-component-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/components/tui-tab.tml
  var import_client4 = __toESM(require_client2());
  var import_temple3 = __toESM(require_temple());
  var TuiTab_30672d032d454a571b45 = class extends import_client4.TempleComponent {
    static component = ["tui-tab", "TuiTab_30672d032d454a571b45"];
    styles() {
      return `:host a {
  ...
  :host(.active) a {
    ...
    template() {
      const { group, selector, ...attributes } = (0, import_temple3.props)();
      const tab = this;
      const init = () => {
      ...
      const show = () => {
        Array.from(document.querySelectorAll(`[group="${group}"]`)).forEach((tab2) => {
          tab2.classList.remove("active");
          const selector2 = tab2.props.selector;
          Array.from(document.querySelectorAll(selector2)).forEach((content) => {
...
`, false),
        import_client4.TempleRegistry.createElement("a", { ...attributes, "class": `tab`, "click": show, "mount": init }, [
  ...
  var types_default = {
    ...
    TempleCompiler: {
      ...
      emitter: {
        ...
        example: "temple().emitter.on('render', e => {\n  console.log(e.patams)\n})"
      },
      manifest: {
        kind: "property",
        list: false,
        ...
        example: "temple().manifest.entries()"
      },
      fromId: {
        kind: "function",
        args: [
      ...
      fromCache: {
        ...
        example: "temple().fromCache('/path/to/build/abc123.js')"
      },
      fromSource: {
        kind: "function",
        args: [
        ...
        example: "temple().fromSource('./docs/api.dhtml')"
      },
      withCache: {
        kind: "function",
        args: [
      ...
      asset: {
        ...
        example: "temple().asset('abc123.css')"
      },
      client: {
        kind: "function",
        async: true,
        ...
        example: "temple().client('./docs/api.dhtml')"
      },
      import: {
        kind: "function",
        async: true,
        ...
        example: "temple().import('/path/to/build/abc123.js')"
      },
      markup: {
        kind: "function",
        async: true,
        ...
        example: "temple().markup('./docs/api.dhtml')"
      },
      render: {
        kind: "function",
        async: true,
        ...
        example: "temple().render('./docs/api.dhtml', { title: 'API Documentation' })"
      },
      server: {
        kind: "function",
        async: true,
        ...
        example: "temple().server('./docs/api.dhtml')"
      },
      styles: {
        kind: "function",
        async: true,
        ...
        example: "temple().styles('./docs/api.dhtml')"
      }
    }
  };
  ...
  var DevUi_87d69b704d467329fbce = class extends import_client5.TempleComponent {
  ...
  h3 {
    ...
    template() {
      const paths = (0, import_temple4.signal)(["TempleCompiler"]);
      const active = (0, import_temple4.signal)("TempleCompiler");
      const next = (e) => {
...
`, false),
        import_client5.TempleRegistry.createElement("div", {}, [
          import_client5.TempleRegistry.createText(`
  `, false),
          import_client5.TempleRegistry.createElement("h3", {}, [
            import_client5.TempleRegistry.createText(`
    `, false),
            ...!!(paths.value.length > 1) ? [
              import_client5.TempleRegistry.createText(`
      `, false),
              import_client5.TempleRegistry.createElement("a", { "click": prev }, [
                import_client5.TempleRegistry.createText(`
        `, false),
                import_client5.TempleRegistry.createElement("i", { "class": `fas fa-arrow-left` }, []).element,
                import_client5.TempleRegistry.createText(`
      `, false)
              ]).element,
              import_client5.TempleRegistry.createText(`
  ...
  `, false)
          ...
          import_client5.TempleRegistry.createText(`
  `, false),
          import_client5.TempleRegistry.createComponent(CodeSnippet_1f2900d78698832785d0, { "lang": `js`, "inline": true, "test": test }, [
            ...this._toNodeList(`console.log('hello ')`)
          ]).element,
          import_client5.TempleRegistry.createText(` 
  `, false),
          import_client5.TempleRegistry.createElement("div", { "class": `tbl-container` }, [
            import_client5.TempleRegistry.createText(`
    `, false),
            import_client5.TempleRegistry.createElement("table", { "class": `tbl` }, [
              import_client5.TempleRegistry.createText(`
      `, false),
              import_client5.TempleRegistry.createElement("thead", {}, [
                import_client5.TempleRegistry.createText(`
        `, false),
                import_client5.TempleRegistry.createElement("th", {}, [
                  import_client5.TempleRegistry.createText(`Property`, false)
                ]).element,
                import_client5.TempleRegistry.createText(`
        `, false),
                import_client5.TempleRegistry.createElement("th", {}, [
                  import_client5.TempleRegistry.createText(`Returns`, false)
                ]).element,
                import_client5.TempleRegistry.createText(`
        `, false),
                import_client5.TempleRegistry.createElement("th", {}, [
                  import_client5.TempleRegistry.createText(`Description`, false)
                ]).element,
                import_client5.TempleRegistry.createText(`
      `, false)
              ]).element,
              import_client5.TempleRegistry.createText(`
      `, false),
              import_client5.TempleRegistry.createElement("tbody", {}, [
                import_client5.TempleRegistry.createText(`
        `, false),
                ...Object.entries(types_default[active.value]).map(([key, prop]) => [
                  import_client5.TempleRegistry.createText(`
          `, false),
                  import_client5.TempleRegistry.createElement("tr", {}, [
                    import_client5.TempleRegistry.createText(`
            `, false),
                    ...!!(prop.kind === "property") ? [
                      import_client5.TempleRegistry.createText(`
              `, false),
                      import_client5.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
              ...
              `, false),
                ...
                `, false),
                        import_client5.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
                          import_client5.TempleRegistry.createText(`
                  `, false),
                          import_client5.TempleRegistry.createElement("a", { "data-type": prop.type, "click": next }, [
                            import_client5.TempleRegistry.createText(`
                    `, false),
              ...
              `, false)
                      ...
                      import_client5.TempleRegistry.createText(`
              `, false),
                      import_client5.TempleRegistry.createElement("td", {}, [
                        import_client5.TempleRegistry.createText(`
                `, false),
              ...
              `, false),
                ...
                `, false),
                  ...
                  `, false),
                    ...
                    `, false),
                          ...!!(index > 0) ? [
                            import_client5.TempleRegistry.createText(`, `, false)
                          ] : [],
                          import_client5.TempleRegistry.createText(`
                    `, false),
                    ...
                    `, false),
                          ...!!types_default[arg.type] ? [
                            import_client5.TempleRegistry.createText(`
                      `, false),
                            import_client5.TempleRegistry.createElement("a", { "data-type": arg.type, "click": next }, [
                              import_client5.TempleRegistry.createText(`
                        `, false),
              ...
              `, false),
                ...
                `, false),
                        import_client5.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
                          import_client5.TempleRegistry.createText(`
                  `, false),
                          import_client5.TempleRegistry.createElement("a", { "data-type": prop.returns.type, "click": next }, [
                            import_client5.TempleRegistry.createText(`
                    `, false),
            ...
            `, false)
              ...
              `, false),
                      import_client5.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
                        import_client5.TempleRegistry.createText(`void`, false)
                      ]).element,
                      import_client5.TempleRegistry.createText(`
              `, false),
                      import_client5.TempleRegistry.createElement("td", {}, [
...
`, false)
  ...
  import_client6.emitter.once("ready", () => {
    ...
    const url = "/docs/";
    const title = "Template Engine - Temple reactive web component template engine.";
    ...
    customElements.define("tui-tab", TuiTab_30672d032d454a571b45);
  ...
  var components = {
    ...
    "TuiTab_30672d032d454a571b45": TuiTab_30672d032d454a571b45,
    "DevUi_87d69b704d467329fbce": DevUi_87d69b704d467329fbce
  };
  var BUILD_ID = "244111111f5c98cca040";
  return __toCommonJS(sandbox_exports);
})();
