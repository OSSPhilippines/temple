var TempleAPI = (() => {
  ...
  var require_TempleComponent = __commonJS({
    "../temple/dist/client/TempleComponent.js"(exports) {
      ...
      var TempleComponent6 = class _TempleComponent extends HTMLElement {
        ...
        set props(props5) {
          this._props = Object.assign({}, props5);
          this._attributes = Object.fromEntries(Object.entries(props5).filter((entry) => typeof entry[1] === "string" || entry[1] === true));
        }
        adoptedCallback() {
          this.render();
        }
  ...
  // temple-document-client-resolver:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/compiler-api.dtml
...
`, false)
  ...
  // temple-component-resolver:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/modules/api/ui.tml
  var import_client3 = __toESM(require_client2());
  var import_temple2 = __toESM(require_temple());

  // src/modules/api/types.json
  var types_default = {
    Asset: {
      type: {
        kind: "property",
  ...
  // temple-component-resolver:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/modules/api/ui.tml
  var Ui_dcdb1ec28ab9a6dac63a = class extends import_client3.TempleComponent {
    static component = ["ui", "Ui_dcdb1ec28ab9a6dac63a"];
    styles() {
      return `:host {
    border-radius: 5px;
  ...
  .container {
    ...
    template() {
      const { start = "TempleCompiler" } = (0, import_temple2.props)();
      const paths = (0, import_temple2.signal)([start]);
      const active = (0, import_temple2.signal)(start);
      const next = (e) => {
      ...
      return () => [
        import_client3.TempleRegistry.createElement("link", { "rel": `stylesheet`, "type": `text/css`, "href": `/temple/styles/fontawesome/all.css` }).element,
        import_client3.TempleRegistry.createText(`
`, false),
        import_client3.TempleRegistry.createElement("div", {}, [
          import_client3.TempleRegistry.createText(`
  `, false),
          import_client3.TempleRegistry.createElement("h3", {}, [
            import_client3.TempleRegistry.createText(`
    `, false),
            ...!!(paths.value.length > 1) ? [
              import_client3.TempleRegistry.createText(`
      `, false),
              import_client3.TempleRegistry.createElement("a", { "click": prev }, [
                import_client3.TempleRegistry.createText(`
        `, false),
                import_client3.TempleRegistry.createElement("i", { "class": `fas fa-arrow-left` }, []).element,
                import_client3.TempleRegistry.createText(`
      `, false)
              ]).element,
              import_client3.TempleRegistry.createText(`
  ...
  `, false)
          ...
          import_client3.TempleRegistry.createText(`
  `, false),
          import_client3.TempleRegistry.createElement("div", { "class": `container` }, [
            import_client3.TempleRegistry.createText(`
    `, false),
            import_client3.TempleRegistry.createElement("div", { "class": `tbl-container` }, [
              import_client3.TempleRegistry.createText(`
      `, false),
              import_client3.TempleRegistry.createElement("table", { "class": `tbl` }, [
                import_client3.TempleRegistry.createText(`
        `, false),
                import_client3.TempleRegistry.createElement("thead", {}, [
                  import_client3.TempleRegistry.createText(`
          `, false),
                  import_client3.TempleRegistry.createElement("th", {}, [
                    import_client3.TempleRegistry.createText(`Property`, false)
                  ]).element,
                  import_client3.TempleRegistry.createText(`
          `, false),
                  import_client3.TempleRegistry.createElement("th", {}, [
                    import_client3.TempleRegistry.createText(`Returns`, false)
                  ]).element,
                  import_client3.TempleRegistry.createText(`
          `, false),
                  import_client3.TempleRegistry.createElement("th", {}, [
                    import_client3.TempleRegistry.createText(`Description`, false)
                  ]).element,
                  import_client3.TempleRegistry.createText(`
        `, false)
                ]).element,
                import_client3.TempleRegistry.createText(`
        `, false),
                import_client3.TempleRegistry.createElement("tbody", {}, [
                  import_client3.TempleRegistry.createText(`
          `, false),
                  ...Object.entries(types_default[active.value]).map(([key, prop]) => [
                    import_client3.TempleRegistry.createText(`
            `, false),
                    import_client3.TempleRegistry.createElement("tr", {}, [
                      import_client3.TempleRegistry.createText(`
              `, false),
                      ...!!(prop.kind === "property") ? [
                        import_client3.TempleRegistry.createText(`
                `, false),
                        import_client3.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
                ...
                `, false),
                  ...
                  `, false),
                          import_client3.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
                            import_client3.TempleRegistry.createText(`
                    `, false),
                            import_client3.TempleRegistry.createElement("a", { "data-type": prop.type, "click": next }, [
                              import_client3.TempleRegistry.createText(`
                      `, false),
                    ...
                    `, false),
                      ...
                      `, false),
                            ...!!types_default[arg.type] ? [
                              import_client3.TempleRegistry.createText(`
                        `, false),
                              import_client3.TempleRegistry.createElement("a", { "data-type": arg.type, "click": next }, [
                                import_client3.TempleRegistry.createText(`
                          `, false),
                ...
                `, false),
                  ...
                  `, false),
                          import_client3.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
                            import_client3.TempleRegistry.createText(`
                    `, false),
                            import_client3.TempleRegistry.createElement("a", { "data-type": prop.returns.type, "click": next }, [
                              import_client3.TempleRegistry.createText(`
                      `, false),
              ...
              `, false)
                ...
                `, false),
                        import_client3.TempleRegistry.createElement("td", { "valign": `top`, "nowrap": true }, [
                          import_client3.TempleRegistry.createText(`void`, false)
                        ]).element,
                        import_client3.TempleRegistry.createText(`
              `, false)
                      ] : [],
                      import_client3.TempleRegistry.createText(`
              `, false),
                      import_client3.TempleRegistry.createElement("td", {}, [
                        import_client3.TempleRegistry.createText(`
                `, false),
                        ...!!prop.description ? [
                          import_client3.TempleRegistry.createText(`
                  `, false),
                          import_client3.TempleRegistry.createElement("p", {}, [
                  ...
                  `, false),
                          ...!!prop.example ? [
                            import_client3.TempleRegistry.createText(`
                    `, false),
                            import_client3.TempleRegistry.createElement("h5", {}, [
                              import_client3.TempleRegistry.createText(`Example`, false)
                            ]).element,
                            import_client3.TempleRegistry.createText(`
                    `, false),
                            import_client3.TempleRegistry.createComponent("ide-code", Code_6f36bc13bb6a166c7abc, { "lang": `js` }, [
...
`, false)
  ...
  var Translate_7d25e372f5ffb5e39dad = class extends import_client4.TempleComponent {
    static component = ["translate", "Translate_7d25e372f5ffb5e39dad"];
    styles() {
      return ``;
    }
    template() {
      const { trim = false, p = false, li = false, div = false } = (0, import_temple3.props)();
    ...
    `, false)
          ...
          import_client4.TempleRegistry.createText(`
      `, false),
          import_client4.TempleRegistry.createElement("li", {}, [
            ...this._toNodeList(translations)
          ]).element,
          import_client4.TempleRegistry.createText(`
    `, false)
  ...
  import_client5.emitter.once("ready", () => {
    ...
    const __BINDINGS__ = { "0": { "class": `head panel-head` }, "1": { "class": `menu fas fa-fw fa-bars`, "click": toggle }, "2": { "href": `/temple` }, "3": { "src": `/temple/temple-icon.png`, "alt": `Temple Logo` }, "5": { "class": `tx-white`, "href": `/temple` }, "7": { "class": `tx-white`, "href": `/temple/docs/index.html` }, "8": { "class": `github`, "href": `https://github.com/OSSPhilippines/temple`, "target": `_blank` }, "9": { "class": `fab fa-github` }, "10": { "class": `npm`, "href": `https://www.npmjs.com/package/@ossph/temple`, "target": `_blank` }, "11": { "class": `fab fa-npm text-white` }, "12": { "class": `discord`, "href": `https://discord.gg/open-source-software-ph-905496362982981723`, "target": `_blank` }, "13": { "class": `fab fa-discord text-white` }, "14": { "class": `left panel-left` }, "16": { "href": `/temple` }, "17": { "src": `/temple/temple-icon.png`, "alt": `Temple Logo` }, "19": { "class": `tx-white`, "href": `/temple` }, "20": { "class": `toggle fas fa-fw fa-chevron-left`, "click": toggle }, "23": { "href": `/temple/docs/index.html` }, "24": { "href": `/temple/docs/getting-started.html` }, "26": { "href": `/temple/docs/markup-syntax.html` }, "27": { "href": `/temple/docs/state-management.html` }, "28": { "href": `/temple/docs/component-strategy.html` }, "29": { "href": `/temple/docs/compiler-api.html` }, "30": { "href": `/temple/docs/client-api.html` }, "32": { "href": `/temple/docs/template-engine.html` }, "33": { "href": `/temple/docs/single-page.html` }, "34": { "href": `/temple/docs/static-site.html` }, "35": { "href": `/temple/docs/component-publisher.html` }, "36": { "href": `/temple/docs/developer-tools.html` }, "37": { "class": `panel-main` }, "38": { "class": `docs container` }, "40": { "p": true, "trim": true }, "41": { "lang": `js`, "trim": true, "detab": 10 }, "42": { "p": true, "trim": true }, "43": { "lang": `js`, "inline": true }, "44": { "start": `TempleOptions` }, "45": { "p": true, "trim": true }, "46": { "lang": `js`, "inline": true }, "47": { "lang": `js`, "inline": true }, "49": { "class": `pager` }, "50": { "class": `prev`, "href": `/temple/docs/component-strategy.html` }, "51": { "class": `fas fa-fw fa-chevron-left` }, "52": { "class": `next`, "href": `/temple/docs/client-api.html` }, "53": { "class": `fas fa-fw fa-chevron-right` }, "54": { "class": `foot` } };
    ...
    customElements.define("api-ui", Ui_dcdb1ec28ab9a6dac63a);
  ...
  var components = {
    ...
    "ApiUi_dcdb1ec28ab9a6dac63a": Ui_dcdb1ec28ab9a6dac63a,
    "I18nTranslate_7d25e372f5ffb5e39dad": Translate_7d25e372f5ffb5e39dad
  };
  var BUILD_ID = "38ccffadc3c6e8b93d28";
