var TempleAPI = (() => {
  ...
  var require_TempleRegistry = __commonJS({
    "../../node_modules/@ossph/temple/dist/client/TempleRegistry.js"(exports) {
      ...
      var TempleRegistry7 = class _TempleRegistry {
        static get elements() {
  ...
  var require_StyleSet = __commonJS({
    "../../node_modules/@ossph/temple/dist/style/StyleSet.js"(exports) {
      ...
      var StyleSet = class extends Map {
  ...
  // temple-document-client-resolver:C:\Users\msu-wone\Documents\@Shoppable (Intern Dev Tasks)\Temple Dev\Push\temple\packages\temple-web\src\pages\500.dtml
  var __exports = {};
  __export(__exports, {
    BUILD_ID: () => BUILD_ID,
    TempleException: () => import_Exception.default,
    TempleRegistry: () => import_TempleRegistry6.default,
...
`, false),
  ...
  var App_1b764cde41f9fec4fa90 = class extends import_TempleComponent2.default {
...
`, false),
        import_TempleRegistry2.default.createElement("div", { "class": `curved scroll-hidden shadow-0-0-10-0-0-0-5` }, [
          import_TempleRegistry2.default.createText(`
  `, false),
          import_TempleRegistry2.default.createElement("div", { "class": `relative flex flex-center-y gap-10 p-10 bg-t-1 tx-c-999999 tx-16` }, [
            import_TempleRegistry2.default.createText(`
    `, false),
            import_TempleRegistry2.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_TempleRegistry2.default.createText(`
    `, false),
            import_TempleRegistry2.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_TempleRegistry2.default.createText(`
    `, false),
            ...
            import_TempleRegistry2.default.createText(`
    `, false),
            import_TempleRegistry2.default.createElement("span", { "class": `flex flex-center h-full w-full absolute top-0 left-0` }, [
              import_TempleRegistry2.default.createText(`
      `, false),
  ...
  `, false)
          ...
          import_TempleRegistry2.default.createText(`
  `, false),
          import_TempleRegistry2.default.createElement("div", { "class": `bg-black tx-t-1 relative`, "style": style }, [
...
`, false)
  ...
  var Code_dc95e1dc263cebe7630e = class extends import_TempleComponent3.default {
  ...
  .terminal span {
    ...
    template() {
      ...
      return () => [
        import_TempleRegistry3.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism.min.css` }).element,
        import_TempleRegistry3.default.createText(`
`, false),
        import_TempleRegistry3.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism-tomorrow.min.css` }).element,
        import_TempleRegistry3.default.createText(`
`, false),
        ...!!(lang === "bash") ? [
          import_TempleRegistry3.default.createText(`
  `, false),
          import_TempleRegistry3.default.createElement("div", { "class": `terminal` }, [
            import_TempleRegistry3.default.createElement("span", {}, [
              import_TempleRegistry3.default.createText(`$`, false)
            ]).element,
            import_TempleRegistry3.default.createText(` `, false),
...
`, false)
  ...
  `, false),
          ...!!numbers ? [
            import_TempleRegistry3.default.createText(`
    `, false),
            import_TempleRegistry3.default.createElement("pre", { "class": `snippet line-numbers` }, [
              import_TempleRegistry3.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_TempleRegistry3.default.createText(`
  `, false)
          ] : true ? [
            ...
            import_TempleRegistry3.default.createText(`
    `, false),
            import_TempleRegistry3.default.createElement("pre", { "class": `snippet pad` }, [
              import_TempleRegistry3.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_TempleRegistry3.default.createText(`
  `, false)
...
`, false)
  ...
  var Preview_1b0dd3446d3d28a5cfe1 = class extends import_TempleComponent4.default {
...
`, false),
        import_TempleRegistry4.default.createElement("div", { "class": `bg-white tx-black arial p-10 h-full` }, [
  ...
  // temple-component-resolver:C:\Users\msu-wone\Documents\@Shoppable (Intern Dev Tasks)\Temple Dev\Push\temple\packages\temple-web\src\components\i18n\translate.tml
  var Translate_28f19068bef58cb5d5e8 = class extends import_TempleComponent5.default {
    ...
    `, false),
        ...!!p ? [
          import_TempleRegistry5.default.createText(`
      `, false),
          import_TempleRegistry5.default.createElement("p", {}, [
    ...
    `, false)
          ...
          import_TempleRegistry5.default.createText(`
      `, false),
          import_TempleRegistry5.default.createElement("li", {}, [
            ...this._toNodeList(translations)
          ]).element,
          import_TempleRegistry5.default.createText(`
    `, false)
          ...
          import_TempleRegistry5.default.createText(`
      `, false),
          import_TempleRegistry5.default.createElement("div", {}, [
            ...this._toNodeList(translations)
          ]).element,
          import_TempleRegistry5.default.createText(`
    `, false)
  ...
  import_TempleEmitter.default.once("ready", () => {
    ...
    for (const element of document.body.querySelectorAll("*")) {
      ...
      const id = String(import_TempleRegistry6.default.elements.size);
      if (__BINDINGS__[id]) {
        Object.assign(attributes, __BINDINGS__[id]);
      }
      import_TempleRegistry6.default.register(element, attributes);
    }
  ...
  var BUILD_ID = "e3f8653650902fcc262b";
