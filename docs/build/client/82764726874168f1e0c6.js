var TempleBundle = (() => {
  ...
  // temple-document-client-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/engine.dtml
  var engine_exports = {};
...
`, false),
  ...
  .container {
    ...
    template() {
      const { start = "TempleCompiler" } = (0, import_temple4.props)();
      const paths = (0, import_temple4.signal)([start]);
      const active = (0, import_temple4.signal)(start);
      const next = (e) => {
...
`, false),
  ...
  `, false)
          ...
          import_client5.TempleRegistry.createText(`
  `, false),
          import_client5.TempleRegistry.createElement("div", { "class": `container` }, [
            import_client5.TempleRegistry.createText(`
    `, false),
                  ...
                  `, false),
                    ...
                    `, false),
                            ...!!prop.example ? [
                              import_client5.TempleRegistry.createText(`
                      `, false),
                              import_client5.TempleRegistry.createElement("h5", {}, [
                                import_client5.TempleRegistry.createText(`Example`, false)
                              ]).element,
                              import_client5.TempleRegistry.createText(`
                      `, false),
                              import_client5.TempleRegistry.createComponent(CodeSnippet_1f2900d78698832785d0, { "lang": `js` }, [
...
`, false)
  ...
  var BUILD_ID = "82764726874168f1e0c6";
