...
${document2}`;
  ...
  // temple-document-server-resolver:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/template-engine.dtml
  var template_engine_exports = {};
  __export(template_engine_exports, {
    default: () => TemplateEngine_2d721d6aed73f41f4e72
  });
  ...
  // temple-document-server-resolver:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/template-engine.dtml
  var TemplateEngine_2d721d6aed73f41f4e72 = class extends import_server.TempleDocument {
    id() {
      return "2d721d6aed73f41f4e72";
    }
    styles() {
      return ``;
    }
      ...
      `, false),
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false)
                      ...
                      import_server.TempleRegistry.createText(`
              `, false),
                      import_server.TempleRegistry.createElement("tui-tab", { "class": `tab`, "group": `project`, "selector": `#page-dtml` }, [
                        import_server.TempleRegistry.createText(`
                src/page.dtml
              `, false)
                      ]),
          ...
          `, false),
            ...
            `, false)
                    ...
                    import_server.TempleRegistry.createText(`
            `, false),
                    import_server.TempleRegistry.createElement("tui-tab", { "class": `shift-1 block`, "group": `project`, "selector": `#page-dtml` }, [
                      import_server.TempleRegistry.createText(`
              `, false),
                      import_server.TempleRegistry.createElement("i", { "class": `fas fa-fw fa-file` }, []),
                      import_server.TempleRegistry.createText(`
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/client-api.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
          ...
          `, false)
                  ...
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `next`, "href": `/temple/docs/single-page.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
...
`, false)
  ...
  return __toCommonJS(template_engine_exports);
})();
