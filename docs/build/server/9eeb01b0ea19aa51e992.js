...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/known-issues.dtml
  var known_issues_exports = {};
  __export(known_issues_exports, {
    default: () => KnownIssues_9eeb01b0ea19aa51e992
  });
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/known-issues.dtml
  var KnownIssues_9eeb01b0ea19aa51e992 = class extends import_server.TempleDocument {
    id() {
      return "9eeb01b0ea19aa51e992";
    }
    styles() {
      return ``;
    }
    template() {
      const url = "/docs/known-issues.html";
      const title = _("Known Issues - Temple reactive web component template engine.");
      const description = _("Current known issues with Temple.");
      const toggle = (_2) => {
      ...
      `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/contributing-guide.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
...
`, false)
  ...
  return __toCommonJS(known_issues_exports);
})();
