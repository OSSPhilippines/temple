...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/contributing-guide.dtml
  var contributing_guide_exports = {};
  __export(contributing_guide_exports, {
    default: () => ContributingGuide_f1b337c769a1305de5fe
  });
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/contributing-guide.dtml
  var ContributingGuide_f1b337c769a1305de5fe = class extends import_server.TempleDocument {
    id() {
      return "f1b337c769a1305de5fe";
    }
    styles() {
      return ``;
    }
    template() {
      const url = "/docs/contributing-guide.html";
      const title = _("Contributing Guide - Temple reactive web component template engine.");
      const description = _("How to contribute to the Temple project.");
      const toggle = (_2) => {
      ...
      `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("h1", {}, [
                  ...this._toNodeList(_("Contributing Guide"))
                ]),
                import_server.TempleRegistry.createText(`
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/latest-updates.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
                    import_server.TempleRegistry.createElement("i", { "class": `fas fa-fw fa-chevron-left` }, []),
                    import_server.TempleRegistry.createText(`
            `, false),
                    ...this._toNodeList(_("Latest Updates")),
                    import_server.TempleRegistry.createText(`
          `, false)
                  ]),
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `next`, "href": `/temple/docs/known-issues.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
                    ...this._toNodeList(_("Known Issues")),
                    import_server.TempleRegistry.createText(`
            `, false),
...
`, false)
  ...
  return __toCommonJS(contributing_guide_exports);
})();
