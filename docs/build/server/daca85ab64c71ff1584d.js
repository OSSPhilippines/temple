...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/latest-updates.dtml
  var latest_updates_exports = {};
  __export(latest_updates_exports, {
    default: () => LatestUpdates_daca85ab64c71ff1584d
  });
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/latest-updates.dtml
  var LatestUpdates_daca85ab64c71ff1584d = class extends import_server.TempleDocument {
    id() {
      return "daca85ab64c71ff1584d";
    }
    styles() {
      return ``;
    }
    template() {
      const url = "/docs/latest-updates.html";
      const title = _("Latest Updates - Temple reactive web component template engine.");
      const description = _("Checkout the latest updates on Temple project.");
      const toggle = (_2) => {
      ...
      `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/developer-tools.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
          ...
          `, false)
                  ...
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `next`, "href": `/temple/docs/contributing-guide.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
...
`, false)
  ...
  return __toCommonJS(latest_updates_exports);
})();
