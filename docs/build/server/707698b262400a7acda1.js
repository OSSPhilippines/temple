...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/static-sites.dtml
  var static_sites_exports = {};
  __export(static_sites_exports, {
    default: () => StaticSites_707698b262400a7acda1
  });
  var import_server = __toESM(require_server2());
  var import_server2 = __toESM(require_server2());
  var StaticSites_707698b262400a7acda1 = class extends import_server.TempleDocument {
    id() {
      return "707698b262400a7acda1";
    }
    styles() {
      return ``;
    }
    ...
    `, false),
      ...
      `, false),
        ...
        `, false)
                ...
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("dev-ui", { "start": `Config` }),
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("p", {}, [
                  import_server.TempleRegistry.createText(`
          ...
          `, false),
                  import_server.TempleRegistry.createElement("code-snippet", { "lang": `js`, "inline": true }, [
                    ...this._toNodeList(`compiler = temple()`)
                  ]),
                  import_server.TempleRegistry.createText(` 
        ...
        `, false)
                ...
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("dev-ui", {}),
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("h2", {}, [
                  import_server.TempleRegistry.createText(`Development Tools`, false)
                ]),
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("p", {}, [
        ...
        `, false),
          ...
          `, false),
                  import_server.TempleRegistry.createElement("code-snippet", { "inline": true }, [
        ...
        `, false),
                import_server.TempleRegistry.createElement("p", {}, [
                  import_server.TempleRegistry.createText(`Re-run the following command in terminal.`, false)
                ]),
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("window-app", { "title": `Terminal` }, [
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/engine.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
          ...
          `, false)
                  ...
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `next`, "href": `/temple/docs/publisher.html` }, [
                    import_server.TempleRegistry.createText(`
...
`, false)
  ...
  return __toCommonJS(static_sites_exports);
})();
