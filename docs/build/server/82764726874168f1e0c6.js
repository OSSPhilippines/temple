...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/engine.dtml
  var engine_exports = {};
  __export(engine_exports, {
    default: () => Engine_82764726874168f1e0c6
  });
  var import_server = __toESM(require_server2());
  var import_server2 = __toESM(require_server2());
  var Engine_82764726874168f1e0c6 = class extends import_server.TempleDocument {
    id() {
      return "82764726874168f1e0c6";
    }
    styles() {
      return ``;
    }
      ...
      `, false),
          ...
          `, false),
            ...
            const server = http.createServer(async (req, res) => {
              ...
              //if home page
                ...
                refresh.sync(compiler.fromSource('./index.dtml'));
                //prepare response
                res.writeHead(200, { 'Content-Type': 'text/html' });
                return res.end(await compiler.render('./index.dtml', {
                  title: 'Hello World'
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/questions.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
          ...
          `, false)
                  ...
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `next`, "href": `/temple/docs/static-sites.html` }, [
                    import_server.TempleRegistry.createText(`
