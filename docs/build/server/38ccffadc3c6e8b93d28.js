...
${document2}`;
  ...
  // temple-document-server-resolver:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/compiler-api.dtml
  var compiler_api_exports = {};
  __export(compiler_api_exports, {
    default: () => CompilerApi_38ccffadc3c6e8b93d28
  });
  ...
  // temple-document-server-resolver:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/compiler-api.dtml
  var CompilerApi_38ccffadc3c6e8b93d28 = class extends import_server.TempleDocument {
    id() {
      return "38ccffadc3c6e8b93d28";
    }
    styles() {
      return ``;
    }
      ...
      `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/component-strategy.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
          ...
          `, false)
                  ...
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `next`, "href": `/temple/docs/client-api.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
