...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/questions.dtml
  var questions_exports = {};
  __export(questions_exports, {
    default: () => Questions_ccb4d5072e35c8ca4c05
  });
  var import_server = __toESM(require_server2());
  var import_server2 = __toESM(require_server2());
  var Questions_ccb4d5072e35c8ca4c05 = class extends import_server.TempleDocument {
    id() {
      return "ccb4d5072e35c8ca4c05";
    }
    styles() {
      return ``;
    }
    template() {
      const url = "/docs/";
      const title = "Questions and Answers - Temple reactive web component template engine.";
      ...
      `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("h1", {}, [
                  import_server.TempleRegistry.createText(`Questions &amp; Answers`, false)
                ]),
                import_server.TempleRegistry.createText(`
        `, false),
        ...
        `, false),
          ...
          `, false)
                  ...
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `next`, "href": `/temple/docs/engine.html` }, [
                    import_server.TempleRegistry.createText(`
            Template Engine
            `, false),
...
`, false)
  ...
  return __toCommonJS(questions_exports);
})();
