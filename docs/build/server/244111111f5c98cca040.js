...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/sandbox.dtml
  var sandbox_exports = {};
  __export(sandbox_exports, {
    default: () => Sandbox_244111111f5c98cca040
  });
  var import_server = __toESM(require_server2());
  var import_server2 = __toESM(require_server2());
  var Sandbox_244111111f5c98cca040 = class extends import_server.TempleDocument {
    id() {
      return "244111111f5c98cca040";
    }
    styles() {
      return `body {
      ...
      `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("h1", {}, [
                  import_server.TempleRegistry.createText(`Sandbox`, false)
                ]),
                import_server.TempleRegistry.createText(`
        `, false),
