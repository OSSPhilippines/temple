...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/frequent-questions.dtml
  var frequent_questions_exports = {};
  __export(frequent_questions_exports, {
    default: () => FrequentQuestions_3ac3bd43a439129794ab
  });
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/frequent-questions.dtml
  var FrequentQuestions_3ac3bd43a439129794ab = class extends import_server.TempleDocument {
    id() {
      return "3ac3bd43a439129794ab";
    }
    styles() {
      return ``;
    }
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
                    ...
                    import_server.TempleRegistry.createText(`
            `, false),
                    ...this._toNodeList(_("Gettings Started")),
                    import_server.TempleRegistry.createText(`
          `, false)
                  ]),
                  import_server.TempleRegistry.createText(`
