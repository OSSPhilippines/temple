...
${document2}`;
  ...
  // temple-document-server-plugin:/Users/cblanquera/server/projects/ossph/temple/packages/temple-web/src/pages/docs/publisher.dtml
  var publisher_exports = {};
  __export(publisher_exports, {
    default: () => Publisher_7a81be5a9650618695fa
  });
  var import_server = __toESM(require_server2());
  var import_server2 = __toESM(require_server2());
  var Publisher_7a81be5a9650618695fa = class extends import_server.TempleDocument {
    id() {
      return "7a81be5a9650618695fa";
    }
    styles() {
      return ``;
    }
      ...
      `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("h1", {}, [
                  import_server.TempleRegistry.createText(`Publish a Web Component`, false)
                ]),
                import_server.TempleRegistry.createText(`
        `, false),
        ...
        `, false),
          ...
          `, false),
                  import_server.TempleRegistry.createElement("code-snippet", { "lang": `js`, "inline": true }, [
                    import_server.TempleRegistry.createText(`'src/component.tml'`, false)
                  ]),
                  import_server.TempleRegistry.createText(` 
        ...
        `, false)
                ...
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("window-app", { "title": `src/component.dtml` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
        ...
        `, false),
                import_server.TempleRegistry.createElement("nav", { "class": `pager` }, [
                  import_server.TempleRegistry.createText(`
          `, false),
                  import_server.TempleRegistry.createElement("a", { "class": `prev`, "href": `/temple/docs/started.html` }, [
                    import_server.TempleRegistry.createText(`
            `, false),
...
`, false)
  ...
  return __toCommonJS(publisher_exports);
})();
